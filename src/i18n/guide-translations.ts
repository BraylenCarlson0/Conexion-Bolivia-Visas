...
export const guideMeta: Record<Locale, { title: string; description: string }> = {
  ...
  hi: {
    title: "बोलीविया वीज़ा गाइड कुस्को 2026 | आवश्यकताएं और प्रक्रिया – Conexión Bolivia",
    description:
      "क्या बोलीविया के लिए वीज़ा चाहिए? पूर्ण गाइड: आवश्यकताएं, दस्तावेज़, कुस्को में प्रोसेसिंग समय और Salar de Uyuni यात्रा।",
  },
};
...
export const guideContent: Record<Locale, GuideContent> = {
  ...
  hi: {
    title: "पूर्ण गाइड: कुस्को में बोलीविया वीज़ा",
    subtitle: "Salar de Uyuni जाने से पहले जानने योग्य सब कुछ",
    intro:
      "चीन, इंडोनेशिया, भारत, सर्बिया, यूक्रेन और अन्य देशों के हजारों यात्री बोलीविया की ओर कुस्को से होकर जाते हैं। यह गाइड बोलीवियाई वाणिज्य दूतावास के सामने हमारे कार्यालय में तेज़ और सुरक्षित वीज़ा प्राप्त करने के बारे में सामान्य प्रश्नों के उत्तर देता है।",
    stepsTitle: "4 चरणों में अपना वीज़ा प्राप्त करें",
    steps: [
      { title: "WhatsApp पर संपर्क करें", text: "अपनी राष्ट्रीयता और यात्रा तिथियां भेजें। हम पुष्टि करेंगे कि वीज़ा चाहिए या नहीं और कौन से दस्तावेज़ तैयार करें।" },
      { title: "दस्तावेज़ तैयार करें", text: "वैध पासपोर्ट, फोटो, कार्यक्रम, होटल बुकिंग, वित्तीय प्रमाण और पीले बुखार का टीका यदि आवश्यक।" },
      { title: "कुस्को में हमारे कार्यालय में आएं", text: "Clorinda Matto de Turner 308, बोलीवियाई वाणिज्य दूतावास के सामने। पहले से दस्तावेज़ भेजने पर पिकअप ~10 मिनट।" },
      { title: "वीज़ा प्राप्त करें और बोलीविया जाएं", text: "वीज़ा तैयार होने पर Salar de Uyuni, La Paz या बोलीवियाई पठार की ओर बिना सीमा देरी के।" },
    ],
    faqTitle: "बोलीविया वीज़ा के बारे में सामान्य प्रश्न",
    faqs: [
      { q: "क्या बोलीविया में प्रवेश के लिए वीज़ा चाहिए?", a: "राष्ट्रीयता पर निर्भर करता है। चीन, भारत, इंडोनेशिया, सर्बिया और यूक्रेन सहित कई देशों के यात्रियों को वीज़ा चाहिए। WhatsApp पर संपर्क करें — मिनटों में पुष्टि।" },
      { q: "क्या मैं कुस्को, पेरू में वीज़ा प्राप्त कर सकता हूँ?", a: "हाँ। कुस्को में बोलीवियाई वाणिज्य दूतावास है और हमारा कार्यालय ठीक सामने है। Salar de Uyuni यात्रियों के लिए सबसे सुविधाजनक।" },
      { q: "कुस्को में प्रक्रिया में कितना समय लगता है?", a: "सभी दस्तावेज़ों के साथ लगभग 30 मिनट। WhatsApp या ईमेल से पहले भेजने पर पिकअप ~10 मिनट।" },
      { q: "पर्यटक वीज़ा के लिए कौन से दस्तावेज़ चाहिए?", a: "आमतौर पर: वैध पासपोर्ट (6+ महीने), सफेद पृष्ठभूमि फोटो, कार्यक्रम, होटल बुकिंग, बैंक स्टेटमेंट और पीला बुखार टीका यदि आवश्यक।" },
      { q: "Salar de Uyuni से पहले वीज़ा चाहिए?", a: "हाँ, यदि आपकी राष्ट्रीयता को आवश्यकता है। सीमा पार करने से पहले कुस्को में प्राप्त करें।" },
      { q: "कुस्को में बोलीवियाई वाणिज्य दूतावास कहाँ है?", a: "कुस्को, पेरू। Conexión Bolivia: Clorinda Matto de Turner 308, वाणिज्य दूतावास के सामने।" },
      { q: "क्या उसी दिन वीज़ा मिल सकता है?", a: "हाँ, अधिकांश मामलों में। सभी दस्तावेज़ों के साथ आएं।" },
      { q: "सीमा पर क्यों नहीं, कुस्को में क्यों?", a: "कुस्को में व्यक्तिगत सहायता, दस्तावेज़ समीक्षा और तेज़ प्रक्रिया मिलती है। सीमा पर कोई सहायता नहीं।" },
    ],
    ctaTitle: "वीज़ा के लिए तैयार?",
    ctaText: "WhatsApp पर लिखें — हम कदम-दर-कदम मार्गदर्शन करते हैं। तुरंत जवाब।",
  },
};
